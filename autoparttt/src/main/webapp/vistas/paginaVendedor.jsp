    ...
    <body>
        ...
        <div class="navbar">
            <div class="navbar-left">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="paginaVendedor.html">Inicio</a>
                    </div>
                </div>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="registrarVentaVende.html">Registrar Venta</a>
                    </div>
                </div>
            </div>
            ...
            <div class="navbar-right">
                ...
                <%
                modelo.Usuario vendedor = (modelo.Usuario) session.getAttribute("Vendedor");
                %>
                <div class="vende">
                    <i class="fas fa-user"></i> 
                    Vendedor <%= vendedor.getNombres_usu() %>
                </div>
        ...
        <%-- <p>
        Bienvenido - ${vendedor.nombres_usu}
        <small>Usted es, ${vendedor.rol.tipo_rol}</small>
    </p>
        --%>
