...
public class Empleado {
    ...
    public Empleado(int id_usuario, String nombres_usu, String apellidos_usu, String telefono_usu, String email_usu, String pass_usu, Rol rol) {
    ...
    public String toString() {
        return "Empleado{" + "id_usuario=" + id_usuario + ", nombres_usu=" + nombres_usu + ", apellidos_usu=" + apellidos_usu + ", telefono_usu=" + telefono_usu + ", email_usu=" + email_usu + ", pass_usu=" + pass_usu + ", rol=" + rol + '}';
    }
