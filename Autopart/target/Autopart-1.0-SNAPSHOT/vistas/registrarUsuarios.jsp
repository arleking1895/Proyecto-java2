        ...
        <div class="navbar">
            <div class="navbar-left">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="vistas/registrarCompraAdmin.html">Registrar Compra Repuestos</a>
                    </div>
                </div>
            </div>
            ...
            <div class="navbar-right">
                ...
                <div class="admin">
                    ...
                    Administrador <%= administrador != null ? administrador.getNombres_usu() : "Invitado" %>
                </div>
                    ...
                    <div class="modal-body">
                        <form id="usuarioForm" action="EmpleadoController?accion=guardar" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input  value="${usuario.id_usuario}"  type="text" class="form-control" id="id_usuario" name="id_usuario" placeholder="Ingrese su cédula" pattern="[0-9]{10}" maxlength="10" required>
                            </div>

                            <div class="mb-3">
                                <label for="nombres" class="form-label">Nombres</label>
                                <input value="${usuario.nombres_usu}" type="text" class="form-control" id="nombres" name="nombres" placeholder="Nombres del cliente" pattern="[A-Za-z ]+" title="Solo letras" required>
                            </div>       
                            ...
                            <div class="mb-3">
                                ...
                                <input  value="${usuario.apellidos_usu}" type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Apellidos del cliente" required>
                            </div>        
                            ...
                            <div class="mb-3">
                                ...
                                <input value="${usuario.telefono_usu}" type="tel" class="form-control" id="telefono" name="telefono"  placeholder="Ingrese su número de teléfono" pattern="[0-9]{10}" maxlength="10" minlength="10" required>
                            </div>         
                            ...
                            <div class="mb-3">
                                ...
                                <input value="${usuario.email_usu}" type="email" class="form-control" id="email" name="email"   placeholder="Ingrese su correo electrónico" required>
                            </div>        
