...
<body>
  ...
  <div class="navbar">
    <div class="navbar-left">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          <a href="paginaAuxiliar.html">Inicio</a>
        </div>
      </div>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          <a href="registrarCompraAuxi.html">Registrar Compra Repuestos</a>
        </div>
      </div>
    </div>
   ...
   <%
                Modelo.Usuario auxiliar = (Modelo.Usuario) session.getAttribute("Auxiliar");
                %>
                <div class="auxi">
                    <i class="fas fa-user"></i> 
                    Auxiliar <%= auxiliar.getNombres_usu() %>
                </div>
